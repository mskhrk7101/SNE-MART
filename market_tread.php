...
<body>
    <form action="market_mylist.php" method="POST" class="back">
        <input type="image" name="back" alt="back" src="img/iconmonstr-arrow-left-circle-thin.png" width="50px" height="50px">
    </form>
    <form action="market_offer.php" method="POST" class="market">
        <input type="submit" name="market" value="オファー" width="50px" height="50px">
    </form>
    <div class="sub-top">
